...
public class Swedish_PackEntityLocoDieselSJLittY6 extends DieselTrain {
    ...
    public Swedish_PackEntityLocoDieselSJLittY6(World world, double d, double d1, double d2){
        this(world);
    ...
    public void updateRiderPosition() {
        ...
        double distance = 5.1f;
        double yOffset = 0.0125;
    ...
    @Override
    public float getOptimalDistance(EntityMinecart cart) { return 2.0125F;
    }
