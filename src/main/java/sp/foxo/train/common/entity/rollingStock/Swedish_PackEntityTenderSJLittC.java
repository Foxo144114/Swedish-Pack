...
public class Swedish_PackEntityTenderSJLittC extends Tender implements IInventory {
	...
	public Swedish_PackEntityTenderSJLittC(World world, double d, double d1, double d2) {
		this(world);
