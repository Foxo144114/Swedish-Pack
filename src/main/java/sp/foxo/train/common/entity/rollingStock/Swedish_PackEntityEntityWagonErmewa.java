...
public class Swedish_PackEntityEntityWagonErmewa extends LiquidTank {
	public int freightInventorySize;

	public Swedish_PackEntityEntityWagonErmewa(World world) {
		super(world);
		initFreightWater();
	}
	...
	public Swedish_PackEntityEntityWagonErmewa(World world, double d, double d1, double d2) {
		this(world);
