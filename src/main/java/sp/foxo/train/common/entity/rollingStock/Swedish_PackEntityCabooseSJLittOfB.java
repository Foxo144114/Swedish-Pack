...
public class Swedish_PackEntityCabooseSJLittOfB extends AbstractWorkCart implements IInventory {
	public Swedish_PackEntityCabooseSJLittOfB(World world) {
		super(world);
	...
	public Swedish_PackEntityCabooseSJLittOfB(World world, double d, double d1, double d2) {
		this(world);
