...
public class Swedish_PackEntityCabooseSJLittOeB extends AbstractWorkCart implements IInventory {
	public Swedish_PackEntityCabooseSJLittOeB(World world) {
		super(world);
	...
	public Swedish_PackEntityCabooseSJLittOeB(World world, double d, double d1, double d2) {
		this(world);
	...
	@Override
	public float[][] getRiderOffsets(){return new float[][]{{1.4f,0.25f,0f}};}
