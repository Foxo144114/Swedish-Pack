...
public class Swedish_PackEntityCabooseSJLittObB extends AbstractWorkCart implements IInventory {
	public Swedish_PackEntityCabooseSJLittObB(World world) {
		super(world);
	...
	public Swedish_PackEntityCabooseSJLittObB(World world, double d, double d1, double d2) {
		this(world);
