...
public class Swedish_PackEntityTenderSJLittA extends Tender implements IInventory {
	...
	public Swedish_PackEntityTenderSJLittA(World world, double d, double d1, double d2) {
		this(world);
