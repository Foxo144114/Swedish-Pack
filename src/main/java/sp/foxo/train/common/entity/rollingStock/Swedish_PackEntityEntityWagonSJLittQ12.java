...
public class Swedish_PackEntityEntityWagonSJLittQ12 extends LiquidTank {
	...
	public Swedish_PackEntityEntityWagonSJLittQ12(World world, double d, double d1, double d2) {
		this(world);
