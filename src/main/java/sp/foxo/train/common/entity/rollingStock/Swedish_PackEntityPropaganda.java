...
public class Swedish_PackEntityPropaganda extends EntityRollingStock {


	public Swedish_PackEntityPropaganda(World world) {
		super(world);
	}

	public Swedish_PackEntityPropaganda(World world, double d, double d1, double d2) {
		this(world);
