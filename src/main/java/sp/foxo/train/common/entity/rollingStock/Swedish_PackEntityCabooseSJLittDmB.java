...
public class Swedish_PackEntityCabooseSJLittDmB extends AbstractWorkCart implements IInventory {
	public Swedish_PackEntityCabooseSJLittDmB(World world) {
		super(world);
	...
	public Swedish_PackEntityCabooseSJLittDmB(World world, double d, double d1, double d2) {
		this(world);
	...
	public float[][] getRiderOffsets(){return new float[][]{{1.5f,0.25f,0f}};}
