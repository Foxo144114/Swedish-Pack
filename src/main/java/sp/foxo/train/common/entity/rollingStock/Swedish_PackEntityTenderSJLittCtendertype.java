...
public class Swedish_PackEntityTenderSJLittCtendertype extends Tender implements IInventory {
	public int freightInventorySize;
	public int numFreightSlots;

	public Swedish_PackEntityTenderSJLittCtendertype(World world) {
	...
	public Swedish_PackEntityTenderSJLittCtendertype(World world, double d, double d1, double d2) {
		this(world);
	...
	public String getInventoryName() {
		return "SJ Litterera C-type Tender";
	}
