...
public class Ctyrk4EntityTenderSJLittCtendertype extends Tender implements IInventory {
	public int freightInventorySize;
	public int numFreightSlots;

	public Ctyrk4EntityTenderSJLittCtendertype(World world) {
	...
	public Ctyrk4EntityTenderSJLittCtendertype(World world, double d, double d1, double d2) {
		this(world);
