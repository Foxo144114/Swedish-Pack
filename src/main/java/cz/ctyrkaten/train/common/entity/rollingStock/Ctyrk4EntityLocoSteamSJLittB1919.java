...
public class Ctyrk4EntityLocoSteamSJLittB1919 extends SteamTrain {
	public Ctyrk4EntityLocoSteamSJLittB1919(World world) {
	...
	public Ctyrk4EntityLocoSteamSJLittB1919(World world, double d, double d1, double d2) {
		this(world);
