...
public class Ctyrk4EntityLocoSteamSJLittB1909 extends SteamTrain {
	public Ctyrk4EntityLocoSteamSJLittB1909(World world) {
	...
	public Ctyrk4EntityLocoSteamSJLittB1909(World world, double d, double d1, double d2) {
		this(world);
